...
class BooksSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://www.treatwell.co.uk/places/treatment-thai-massage/offer-type-local/in-london-uk/',
    ]
    ...
    def parse_book_page(self, response):
        ...
        item["img"] = product.css("div.Carousel-module--wrapper--be7da7 > div > div > img").xpath('@src').getall()
